...
export type { BlockSiteCheckInput, UnblockSiteCheckInput, UpdateProjectNotesInput, UpdateAtticGateInput, UploadPhotoEvidenceInput, UpdateUserInput, MarkPhaseReadyForInspectionInput, UpdateProjectInput, UpdatePhaseInput } from "./adapters/prototype";
